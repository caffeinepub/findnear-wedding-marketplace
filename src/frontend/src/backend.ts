...
export class Backend implements backendInterface {
    ...
    async getAllBusinessListings(): Promise<Array<BusinessListing>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllBusinessListings();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitBusinessListing(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint, arg6: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitBusinessListing(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
